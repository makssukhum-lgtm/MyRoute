    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_id', models.BigIntegerField(blank=True, null=True, unique=True, verbose_name='ID пользователя в Telegram')),
                ...
                ('role', models.CharField(blank=True, choices=[('PASSENGER', 'Пассажир'), ('DRIVER', 'Водитель')], max_length=10, null=True, verbose_name='Роль')),
                ('verification_status', models.CharField(choices=[('NOT_VERIFIED', 'Не проверен'), ('PENDING', 'На проверке'), ('VERIFIED', 'Проверен'), ('REJECTED', 'Отклонен')], default='NOT_VERIFIED', max_length=20, verbose_name='Статус верификации')),
